...
@section('page-title', __('page.add_new_post'))
   ...
   <div class="card">
    <div class="card-body">
     ...
     <div class="form-group mb-3">
      <input type="text" class="form-control" name="title" placeholder="{{ __('placeholder.add_post_title') }}" value="{{ old('title') }}" autocomplete="off">
     </div>
